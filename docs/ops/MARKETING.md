...
The fourth v11 slot began with current public and site-side evidence and did
not run the separate weekly catalog job. Before publication, Pinterest API v5
confirmed the correct `goosegifts` BUSINESS account with 25 Pins, 443 public
impressions, four Pin clicks, one save, and zero outbound clicks. All three
existing v11 Pins remained at zero impressions and actions. GA4 had 80
trailing-seven-day sessions and no Pinterest source; its one outbound event is
documented QA. The database recorded zero customer product clicks after
excluding two QA receipts, and Search Console's September 12–18 window had
zero clicks. Pinterest v3 and Sandbox remained excluded.

The enriched-catalog shortlist supplied the SYZ wooden table-top mini bowling
game (`B082PSJYYP`). Amazon Creators API reverified it `IN_STOCK` at `$9.99`;
its canonical Goose destination returned `200`, self-canonical, and `index,
follow`. Three Arm P concepts were recorded. The generic inbox-stress setup was
rejected before generation. The after-hours boardroom and rainy-day parlor
posters were generated at 1024×1536 and inspected at original resolution. That
inspection corrected an initial small-image count from six pins to the source's
eight; the durable prompt history preserves the mistaken wording while both
outputs visibly retain all eight pins. The parlor image passed at `4.75/5` but
was less surprising. The boardroom `THE BREAK ROOM HAS LANES` poster became the
sole survivor at `4.88/5`, passing every product-truth, no-CTA, no-template,
typography, and visible-artifact gate. No third call was justified.

The guarded production dry run verified the exact standing-authorized package,
correct account, `Novelty Desk Toys` board, unique Arm P UTM, first daily slot,
and 1024×1536 artifact. Pinterest created and read-verified public Pin
`1107815208389000013` and wrote receipt
`receipt-1789836323812-editorial-mini-bowling-boardroom-poster-20260919-am-publication-succeeded`.
Its canonical tracked destination is live and indexable. The baseline was zero
actions about 15 seconds after publication. The profile now has 26 Pins and 444
aggregate impressions; v11 is Arm F 2/6, Arm P 2/6, and 4/12 overall. All four
remain undistributed, so there is no arm verdict. No video, weekly catalog job,
SEO page change, outreach, second daily Pin, paid tool, account change,
...
cohort is complete and paused. Pinterest production API v5 confirmed the
correct `goosegifts` BUSINESS account, 22 public Pins, 275 impressions, three
Pin clicks, one save, and zero outbound clicks. The five impressions added
since the prior documented pull landed on the older Ceramic Eye and Lick'em
Pins, not either format-test arm. Arm A remains six Pins at zero impressions;
Arm B remains six Pins at one impression; neither arm has a save, Pin click,
Pinterest outbound click, attributable site session, or downstream product
click.

Dog Toy's seven-day checkpoint was captured seven days, one minute, and two
seconds after its exact production receipt and remained zero across every
Pinterest and downstream metric. Four of six Arm A Pins and four of six Arm B
Pins are now seven-day eligible; the eight eligible Pins have one combined
impression, so clean versus headline remains unevaluable. GA4 recorded 10
trailing-seven-day sessions from Direct, Amazon Organic Shopping, or
Unassigned and no Pinterest source or `product_click` / `affiliate_click` row.
The database recorded no product click in 24 hours and no non-QA product click
in seven days; its two seven-day clicks are explicitly tagged QA. The
owner-review queue remains empty. No product was selected, no asset was
generated, and no public write was attempted. Keep the experiment paused,
capture My First Fire only after its exact seven-day boundary at
2026-09-13T23:49:58.413Z, and compare the complete arms only after American
Mustache reaches seven days on 2026-09-15 and before Cameron selects the next
experiment. Pinterest v3 and Sandbox remain excluded.

### 2026-09-12 afternoon measurement hold

This scheduled slot remained a metric-only no-op because the bounded 12-Pin
cohort is complete and paused. Pinterest production API v5 confirmed the
correct `goosegifts` BUSINESS account, 22 public Pins, 270 impressions, three
Pin clicks, one save, and zero outbound clicks. The one impression added since
the morning pull landed on Raw Chicken, not either format-test arm. Arm A
remains six Pins at zero impressions; Arm B remains six Pins at one impression;
neither arm has a save, Pin click, Pinterest outbound click, attributable site
session, or downstream product click.

Shark Mug's seven-day checkpoint was captured seven days, three minutes, and
13 seconds after its exact production receipt and remained zero across every
Pinterest and downstream metric. Three of six Arm A Pins and four of six Arm B
Pins are now seven-day eligible; the seven eligible Pins have one combined
impression, so clean versus headline remains unevaluable. GA4 recorded 11
trailing-seven-day sessions from Direct or Amazon Organic Shopping and no
Pinterest source or `product_click` / `affiliate_click` row. The database
recorded no product click in 24 hours and no non-QA product click in seven days;
its two seven-day clicks are explicitly tagged QA. The owner-review queue
remains empty. No product was selected, no asset was generated, and no public
write was attempted. Keep the experiment paused, capture Dog Toy only after
its exact seven-day boundary at 2026-09-13T16:42:17.232Z, and compare the
complete arms only after American Mustache reaches seven days on 2026-09-15
and before Cameron selects the next experiment. Pinterest v3 and Sandbox remain
excluded.

### 2026-09-12 morning measurement hold

This scheduled slot remained a metric-only no-op because the bounded 12-Pin
cohort is complete and paused. Pinterest production API v5 confirmed the
correct `goosegifts` BUSINESS account, 22 public Pins, 269 impressions, three
Pin clicks, one save, and zero outbound clicks. The three impressions added
since the prior documented run landed on Raw Chicken, Lick'em, and Hippo
Vanity, not either format-test arm. Arm A remains six Pins at zero impressions;
Arm B remains six Pins at one impression; neither arm has a save, Pin click,
Pinterest outbound click, attributable site session, or downstream product
click.

Medieval Cat and Wacky Tube Guy were captured at their first scheduled
post-seven-day checkpoints, both with zero impressions or action. Gratiator's
checkpoint was captured 15 seconds after its exact seven-day boundary and was
also zero. Two of six Arm A Pins and four of six Arm B Pins are now eligible;
the eligible Arm B Pins have one combined impression, so there is still no
format-response evidence. GA4 recorded 11 trailing-seven-day sessions from
Direct or Amazon Organic Shopping and no Pinterest source or `product_click` /
`affiliate_click` row. The database recorded no product click in 24 hours; its
...
production API v5 confirmed the correct `goosegifts` BUSINESS account, 22
public Pins, 266 impressions, three Pin clicks, one save, and zero outbound
clicks. The one impression added since the prior slot landed on the older July
ceramic-eye editorial, not either test arm. Arm A remains six Pins at zero
impressions; Arm B remains six Pins at one impression; neither arm has a save,
Pin click, Pinterest outbound click, attributable site session, or downstream
product click.

Toilet Golf, the second Arm B candidate to reach seven days, had zero
impressions or action at its checkpoint captured seven days and 62 seconds
after publication. Together with Bullshit Button's one impression, the two
eligible Arm B Pins remain delivery-limited rather than evaluable on headline
response. GA4 recorded 13 trailing-seven-day sessions from Direct, Amazon
Organic Shopping, or Unassigned, with no Pinterest source or `product_click` /
`affiliate_click` row. The database recorded no product click in 24 hours; its
two seven-day clicks remain explicitly tagged PostHog QA. The owner-review
queue remains empty. No product was selected, no asset was generated, and no
